...
export const HARDWARE_SPECS: HardwareSpec[] = [
  {
    ...
    ram: "20 GB DDR4-3200",
    os: "Windows 11 Home Single Language, Edición 25H2, Versión 26200.8457, Nativo de 64 bits | Fedora, Workstation 34, GNOME Version 40, Kernel Version Linux 5.11.12-300, Nativo.",
    notes: "SMT (Hyperthreading) habilitado durante todas las pruebas.",
  },
  {
    id: "env-b",
    name: "Entorno B — Laptop 2",
    role: "laptop",
    ...
    ram: "16 GB LPDDR5",
    os: "Windows 11 Home Single Language, Edición 25H2, Versión 26200.8039, Nativo | Ubuntu 24.04.4 LTS, GNOME Version 46, Kernel Version Linux 6.17.0-20-generic, Nativo.",
    notes: "SMT (Hyperthreading) habilitado. Firmware Version L1CN30WW.",
  },
  {
    id: "env-c",
